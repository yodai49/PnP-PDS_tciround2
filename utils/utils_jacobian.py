...
This implementation is borrowed from https://github.com/basp-group/PnP-MMO-imaging
(originally inspired from https://github.com/facebookresearch/jacobian_regularizer/blob/master/jacobian/jacobian.py)
"""
